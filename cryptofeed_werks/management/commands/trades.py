...
from cryptofeed_werks.models import Candle, Future, Symbol
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options) -> tuple:
        ...
        try:
            symbol = Symbol.objects.get(exchange=exchange, name=symbol)
            ...
            def on_data_frame(
                ...
                """On data_frame, write candles and aggregated data."""
                Candle.write(
                    symbol,
                    timestamp_from,
                    timestamp_to,
