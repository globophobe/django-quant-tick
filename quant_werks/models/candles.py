...
from quant_werks.constants import CandleType, Frequency
...
class CandleSymbol(models.Model):
    candle = models.ForeignKey(
        "quant_werks.Candle", on_delete=models.CASCADE, verbose_name=_("candle")
    )
    symbol = models.ForeignKey(
        "quant_werks.Symbol", on_delete=models.CASCADE, verbose_name=_("symbol")
    )
...
class CandleData(BaseDataStorage):
    candle = models.ForeignKey(
        "quant_werks.Candle", related_name="data", on_delete=models.CASCADE
    )
    symbol = models.ForeignKey(
        "quant_werks.Symbol", related_name="data", on_delete=models.CASCADE
    )
